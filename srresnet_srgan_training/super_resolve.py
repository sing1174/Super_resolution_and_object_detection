...
def visualize_sr(img, halve=False):
    ...
    text_size = font.getbbox("Bicubic")[2:]
    ...
    text_size = font.getbbox("SRResNet")[2:]
    draw.text(
    ...
    text_size = font.getbbox("SRGAN")[2:]
    draw.text(
    ...
    text_size = font.getbbox("Original HR")[2:]
...
if __name__ == '__main__':
    grid_img = visualize_sr("dota/test/images/P0016.png")   #visualize_sr("/media/ssd/sr data/Set14/baboon.png")
